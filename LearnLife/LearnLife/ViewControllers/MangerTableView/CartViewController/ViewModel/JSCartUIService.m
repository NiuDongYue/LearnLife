...
- (void)configureCell:(JSCartCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.clickGoodsImageViewAction = ^(JSCartCell *cartCell) {
    
    };
}

- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    JSCartModel *model = self.viewModel.cartData[indexPath.section][indexPath.row];
    if (self.clickCellAction) {
        self.clickCellAction(model);
    }
}
