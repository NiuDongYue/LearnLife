...
-(void)initUI{
    ...
    self.dayLabel.frame = CGRectMake(0, 0, 40, 40);
    ...
    self.hourLabel.frame = CGRectMake(40, 0, 40, 40);
    ...
    self.minuteLabel.frame = CGRectMake(80, 0, 40, 40);
    ...
    self.secondLabel.frame = CGRectMake(120, 0, 40, 40);
